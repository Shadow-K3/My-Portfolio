...
<template>
  <header class="sticky top-0 left-0 w-full z-[100] backdrop-blur-md border-b border-white/5 font-mono bg-[#0B1120]/80">
    <div class="max-w-[1200px] mx-auto flex justify-between items-center py-6 px-6">
      ...
      <router-link to="/" class="flex items-center gap-2 z-[110] group">
        <Box class="w-5 h-5 text-teal-400 transition-transform duration-500 group-hover:rotate-90" />
      ...
      <button @click="toggleMenu" class="md:hidden text-slate-400 z-[110] p-2 focus:outline-none">
